...
```bash
$ kubectl create -f ./mysql-openssl-openssl-blueprint.yaml -n kanister
```
...
$ kanctl create actionset --action backup --namespace kanister --blueprint mysql-openssl-blueprint --statefulset mysql-test/mysql-release-master --profile mysql-test/s3-profile-drnw9 --secrets mysql=mysql-test/mysql-release
...
```bash
$ kubectl delete blueprints.cr.kanister.io mysql-openssl-blueprint -n kanister
